/*
* @Author: UEK-2016
* @Date:   2017-11-02 14:59:26
* @Last Modified by:   UEK-2016
* @Last Modified time: 2017-11-09 14:43:25
*/
    ...
    $.each(data,function (index,val) {
        if(state==="wait"){
            if(val.isDown===0){
                ...
                str+=" <li style='background:"+val.color+"' id='"+index+"'> <time> <span>"+getdate(val.time)+"</span> <span>"+gethour(val.time)+"</span></time><p>"+val.con+"</p><i class='"+className+"'>0</i><div class='finish'>完成</div> </li>"
            }
        }else if(state==="done"){
            if(val.isDown===1){
                str+=" <li style='background:brown' id='"+index+"'> <time> <span>"+getdate(val.time)+"</span> <span>"+gethour(val.time)+"</span> </time><p>"+val.con+"</p><i class='"+className+"'>0</i><div class='del'>删除</div> </li>"
            }
        }
        console.log(index);
    });
